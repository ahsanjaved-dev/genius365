...
export interface Database {
  public: {
    Tables: {
      super_admin: {
        Row: SuperAdmin
        Insert: Partial<SuperAdmin> & Pick<SuperAdmin, "id" | "email">
      ...
      users: {
        Row: User
        Insert: Partial<User> & Pick<User, "id" | "organization_id" | "email" | "role">
        Update: Partial<User>
      }
      departments: {
        Row: Department
        Insert: Partial<Department> & Pick<Department, "organization_id" | "name" | "slug">
        Update: Partial<Department>
      }
      department_permissions: {
        Row: DepartmentPermission
        Insert: Partial<DepartmentPermission> &
          Pick<DepartmentPermission, "user_id" | "department_id" | "role">
        Update: Partial<DepartmentPermission>
      }
      invitations: {
        Row: Invitation
        Insert: Partial<Invitation> & Pick<Invitation, "type" | "email" | "role" | "invited_by">
        Update: Partial<Invitation>
      }
      ai_agents: {
        Row: AIAgent
        Insert: Partial<AIAgent> &
          Pick<AIAgent, "organization_id" | "department_id" | "name" | "provider">
        Update: Partial<AIAgent>
      }
      conversations: {
        Row: Conversation
        Insert: Partial<Conversation> &
          Pick<Conversation, "organization_id" | "department_id" | "direction" | "status">
        Update: Partial<Conversation>
      }
      usage_tracking: {
        Row: UsageTracking
        Insert: Partial<UsageTracking> &
          Pick<UsageTracking, "organization_id" | "resource_type" | "quantity">
